...
const BookingForm = () => {
    ...
    if (success) {
        ...
        return (
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex gap-6 h-[calc(100vh-100px)]">
                <div className="flex-1 max-w-2xl mx-auto space-y-8 text-center pt-10 overflow-y-auto">
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-100px)]">

            {/* Main Form Area - Scrollable */}
            <div className="flex-1 space-y-6 overflow-y-auto pr-2 pb-20 no-scrollbar">

                {/* Header / Status */}
                <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-0 z-10">
                    <div>
